...
public class OrderRepositoryImpl implements OrderRepository {
    ...
    public Order insert(Order order) {
        ...
        order.setCreatedOn(((Timestamp) Objects.requireNonNull(keyHolder.getKeys()).get("created_on")).toLocalDateTime());
        order.setModifiedOn(((Timestamp) Objects.requireNonNull(keyHolder.getKeys()).get("modified_on")).toLocalDateTime());
        return order;
    }
