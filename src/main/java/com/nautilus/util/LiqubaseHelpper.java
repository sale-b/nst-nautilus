 ...
 */
public class LiqubaseHelpper {

    /** Path for DB Changelog. */
    private static final String DB_CHANGELOG = "changelog/db.changelog-master.yaml";
     ...
     */
    public LiqubaseHelpper(final DataSource dataSource) {
     ...
     */
    public LiqubaseHelpper checkAndFail() {
